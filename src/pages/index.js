  ...
  return (
    <Fragment>
      <Head>
        ...
        <meta
          name='description'
          content='Peintures Hazard-Samin, artisan peintre à Valenciennes, site officiel. Notre entreprise de peinture en batiment, décoration d’intérieur, revêtements de sol et aménagements intérieurs est située à Aulnoye-Lez-Valenciennes et reconnue dans le Valenciennois'
        />
        <meta
          property='og:url'
