    ...
    <>
      ...
      <div style={{ margin: '10%', textAlign: 'justify' }}>
        <p>
          ...
          site internet https://peintures-hazard-samin.fr sont :
        </p>
        <strong> Éditeur du Site :</strong>
        <p>
          Peintures Hazard-Samin : Responsable éditorial Numéro de SIRET :
          75162013900038 email : hazard.samin@gmail.com
        </p>
        ...
        informations auprès de Peintures Hazard-Samin , et signaler toutes
        modifications du site qu’il jugerait utile. Peintures Hazard-Samin n’est
        ...
        Internet.Peintures Hazard-Samin ne dispose d’aucun moyen pour contrôler
        les sites en connexion avec ses sites internet. Peintures Hazard-Samin
        ...
        l’autorisation expresse et préalable de Peintures Hazard-Samin. Dans
        l’hypothèse où un utilisateur ou visiteur souhaiterait mettre en place
        un hyperlien en direction d’un des sites internet de Peintures
        Hazard-Samin., il lui appartiendra d’adresser un email accessible sur le
        site afin de formuler sa demande de mise en place d’un hyperlien.
        Peintures Hazard-Samin. se réserve le droit d’accepter ou de refuser un
        hyperlien sans avoir à en justifier sa décision.
        <h2>Services fournis</h2>
        L’ensemble des activités de Peintures Hazard-Samin ainsi que ses
        informations sont présentés sur notre {process.env.doamin}. Peintures
        Hazard-Samin s’efforce de fournir sur le site {process.env.domain}des
        ...
        courriel, à l’adresse hazard.samin@gmail.com, en décrivant le problème
        ...
        <p>
          ...
          Peintures Hazard-Samin. Cette représentation ou reproduction, par
